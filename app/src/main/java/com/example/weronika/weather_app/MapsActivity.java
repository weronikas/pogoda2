package com.example.weronika.weather_app;
...
import com.example.weronika.weather_app.R;
...
public class MapsActivity extends FragmentActivity {
    ...
    private static String OWM_TILE_URL = "http://tile.openweathermap.org/map/%s/%d/%d/%d.png?appid=d79f2c360afb48b8837de5c38fb91dcf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] tileName = new String[]{"Clouds", "Temperature", "Precipitations", "Snow", "Rain", "Wind", "Pressure"};
    ...
    private TileProvider createTransparentTileProvider() {
        return new com.example.weronika.weather_app.TransparentTileOWM(tileType);
    }
    ...
    private TileProvider createTilePovider() {
        TileProvider tileProvider = new UrlTileProvider(256, 256) {
            ...
            public URL getTileUrl(int x, int y, int zoom) {
                String fUrl = String.format(OWM_TILE_URL, tileType == null ? "clouds_new" : tileType, zoom, x, y);
                URL url = null;
                try {
                    url = new URL(fUrl);
                }
